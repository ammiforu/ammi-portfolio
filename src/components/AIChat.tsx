...
export const AIChat: React.FC = () => {
  ...
  return (
    <>
      {/* Floating Action Container: Docked Callout Pill & Launcher Button */}
        ...
        <AnimatePresence>
          {!open && showNudge && (
            <motion.div
              ...
              className="cursor-pointer group hidden sm:flex items-center gap-2.5 pl-3.5 pr-2 py-2 rounded-2xl bg-[#0c0d18]/95 border border-[#00f0ff]/40 shadow-[0_4px_30px_rgba(0,240,255,0.25)] backdrop-blur-md hover:border-[#00f0ff] hover:shadow-[0_4px_35px_rgba(0,240,255,0.45)] transition-all duration-300"
            >
              ...
              <div className="text-left">
                <div className="text-xs font-bold font-syne text-white flex items-center gap-1.5 leading-tight">
                  <span>Ask Ammi's AI</span>
                  <span className="text-[#00f0ff]">⚡ Instant Answers</span>
                </div>
                <div className="text-[10px] font-mono text-[#9496a8] leading-tight">
                  13+ Yrs Enterprise IT & AI
                </div>
              </div>
              <button
                type="button"
